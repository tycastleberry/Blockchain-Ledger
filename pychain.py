...
sender_input = st.text_input("Enter a value for the sender")

# @TODO:
# Add an input area where you can get a value for `receiver` from the user.
receiver_input = st.text_input("Enter a value for the receiver")

# @TODO:
# Add an input area where you can get a value for `amount` from the user.
amount_input = st.text_input("Enter an amount")
